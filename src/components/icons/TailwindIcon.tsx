export default function TailwindIcon() {
  return (
    <div className="w-full h-full rounded-lg group flex flex-col gap-2 items-center justify-center border border-gray-800">
      <svg
        className="w-7 h-7 dark:text-white text-black group-hover:text-cyan-400 transition duration-300 group-hover:-translate-y-1"
        viewBox="0 0 32 32"
      ...
      <p className="dark:text-white text-black text-xs">Tailwind CSS</p>
    </div>
  );
}
