  ...
  return (
    <div className="w-full h-full rounded-lg group flex flex-col gap-2 items-center justify-center border border-gray-800">
      <svg
        ...
        className="w-7 h-7 dark:text-white text-black transition duration-300 group-hover:text-yellow-300 group-hover:-translate-y-1"
      >
      ...
      <p className="dark:text-white text-black text-xs">TypeScript</p>
    </div>
  );
}
