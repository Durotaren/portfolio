  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex gap-4 pt-1">
        <a
          className="flex justify-center items-center gap-2 border-2 dark:border-white border-black px-[16px] py-[8px] rounded-md dark:hover:bg-[#262626] hover:bg-[#F5F5F5] transition-colors cursor-pointer dark:text-white text-black noopener noreferrer"
          href={githubLink}
          target="_blank"
        >
          <svg
            ...
            className="w-6 h-6 dark:text-white text-black transition-colors duration-100"
          >
        ...
        <a
          className="flex justify-center items-center gap-2 dark:bg-white bg-black rounded-md hover:bg-[#2E2E2E] dark:hover:bg-[#E2E2E2] transition-colors px-[20px] py-[8px] cursor-pointer dark:text-black text-white noopener noreferrer"
          href={liveDemoLink}
          target="_blank"
        >
          <svg
